...
//      fun(currentPage);
    ...
    "initPageEvent": function (listCount) {
        $("#" + page.pageId + ">button[class='pageItem']").on("click", function () {
    ...
    "getPageListModel": function (pageCount, currentPage) {
        ...
        var appendStr = "";
        appendStr += "<button class='" + prePageClass + "' page-data='1' page-rel='firstpage'>首页</button>";
        appendStr += "<button class='" + prePageClass + "' page-data='" + prePage + "' page-rel='prepage'>&lt;上一页</button>";
        ...
        for (var i = 0; i < showPageNum; i++) {
            ...
            appendStr += "<button class='" + itemPageClass + "' page-data='" + pageNumber + "' page-rel='itempage'>" + pageNumber + "</button>";
        }
        appendStr += "<button class='" + nextPageClass + "' page-data='" + nextPage + "' page-rel='nextpage'>下一页&gt;</button>";
        appendStr += "<button class='" + nextPageClass + "' page-data='" + pageCount + "' page-rel='lastpage'>尾页</button>";
        return appendStr;
    }
};